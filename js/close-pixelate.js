...
ClosePixelate.replaceImageNode = function( img, originalNode, renderOptions ) {
  ...
  //HARD RESIZE COULD BE DONE HERE
    ...
    for ( var row = 0; row < rows; row++ ) {
      ...
      for ( var col = 0; col < cols; col++ ) {
        var x = ( col - 0.5 ) * res + offsetX,
            ...
            red = ClosePixelate.imgData[ pixelIndex + 0 ] - ( ClosePixelate.imgData[ pixelIndex + 0 ] % color ),
            green = ClosePixelate.imgData[ pixelIndex + 1 ]- ( ClosePixelate.imgData[ pixelIndex + 1 ] % color ),
            blue = ClosePixelate.imgData[ pixelIndex + 2 ] - ( ClosePixelate.imgData[ pixelIndex + 2 ] % color ),
